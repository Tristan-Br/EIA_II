...
function handleLoad() {
    ...
    let tsbutton = document.getElementById("tsbutton");
    let gemischtbutton = document.getElementById("gemischtbutton");
...
function chooseQuestionsHTML() {
    //Zufällige Auswahl einer Frage aus den HTML-Fragen
    let newhtmlquestion = htmlquestions[Math.floor(Math.random())];
}
function chooseQuestionsCSS() {
    //Zufällige Auswahl einer Frage aus den CSS-Fragen
    let newcssquestion = htmlquestions[Math.floor(Math.random())];
}
function chooseQuestionsTS() {
    //Zufällige Auswahl einer Frage aus den Typescript-Fragen
    let newtsquestion = htmlquestions[Math.floor(Math.random())];
}
function chooseQuestionsGemischt() {
    //Zufällige Auswahl einer Frage aus den Gemischt-Fragen
    let newgemischtquestion = htmlquestions[Math.floor(Math.random())];
}
